 ...
 */
package com.zhenglee.framework.ui.permissions;
...
public class Permissions {
    ...
    public static void requestPermissions(final Object object, String rationale, @StringRes int positiveButton, @StringRes int negativeButton, final int requestCode, final String... perms) {
        ...
        if (shouldShowRationale) {
            //如果需要加以说明
//            final Dialog dialog = new Dialog(getActivity(object), android.os.Build.VERSION.SDK_INT >= 11 ? android.R.style.Theme_Holo_Dialog : android.R.style.Theme_Dialog);
//            dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
//            View view = View.inflate(getActivity(object), R.layout.dialog_permission, null);
...
//                }
//            });
//            ((TextView) view.findViewById(R.id.dialog_permission_message)).setText(rationale);
