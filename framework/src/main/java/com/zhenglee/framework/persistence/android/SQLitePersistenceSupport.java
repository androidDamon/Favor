 ...
 */
public abstract class SQLitePersistenceSupport extends SQLiteOpenHelper implements Comparator<SQLiteUpgradeHandler>, SQLitePersistenceManager {

    public SQLitePersistenceSupport(Context context, String name, CursorFactory factory, int version) {
