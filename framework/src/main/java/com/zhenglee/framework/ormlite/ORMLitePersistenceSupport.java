 ...
 */
public abstract class ORMLitePersistenceSupport extends OrmLiteSqliteOpenHelper implements Comparator<ORMLiteUpgradeHandler>, ORMLitePersistenceManager {
    ...
    public ORMLitePersistenceSupport(Context context, String name, CursorFactory factory, int version) {
    ...
    public void onUpgrade(SQLiteDatabase db, ConnectionSource cs, int oldVersion, int newVersion) {
        ...
        if (null == handlers || handlers.length <= 0) return;
