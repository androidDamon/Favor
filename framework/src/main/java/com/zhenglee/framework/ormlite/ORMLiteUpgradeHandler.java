...
public abstract class ORMLiteUpgradeHandler extends AbstractUpgradeHandler {
    ...
    public ORMLiteUpgradeHandler(PersistenceManager persistenceManager, int targetVersion) {
    ...
    public abstract void upgrade(SQLiteDatabase db, ConnectionSource cs, int oldVersion, int newVersion);
